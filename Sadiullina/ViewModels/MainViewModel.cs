...
namespace Sadiullina.ViewModels
{
    public class MainViewModel : ViewModelBase
    {
        ...
        public ICommand? ViewSalesHistoryCommand { get; private set; }
        ...
        private void InitializeCommands()
        {
            ...
            ViewSalesHistoryCommand = new RelayCommand(ExecuteViewSalesHistory, () => SelectedPartner != null);
            RefreshCommand = new RelayCommand(async () => await LoadPartnersAsync());
        }
        ...
        private void ExecuteViewSalesHistory()
        {
            if (SelectedPartner == null) return;

            var historyWindow = new SalesHistoryWindow();
            historyWindow.Title = $"История продаж - {SelectedPartner.CompanyName}";

            var viewModel = new SalesHistoryViewModel(_partnerService, SelectedPartner.Id);
